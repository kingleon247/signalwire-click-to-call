				...
				<Toolbar>
					...
					<div>
						...
						<Menu
							...
							onClose={handleClose}
						>
							<MenuItem component={MxLink} href={'/dashboard'}><DashboardIcon
								sx={{fontSize: 18, mr: 1, color: 'gray'}}/> Dashboard</MenuItem>
							<MenuItem component={MxLink} href={'/settings'}><SettingsIcon
								sx={{fontSize: 18, mr: 1, color: 'gray'}}/> Settings</MenuItem>
							<MenuItem component={MxLink} href={'/'}><LandingPageIcon
								sx={{fontSize: 18, mr: 1, color: 'gray'}}/> Landing Page</MenuItem>
							<Divider sx={{my: 0.5}}/>
